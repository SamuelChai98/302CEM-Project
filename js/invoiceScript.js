function productTotalPriceCount(){
  var q = document.getElementById("iPQuantity").value;
  var p = document.getElementById("iPPrice").value;
  var ta = q * p;
  ta = parseFloat(ta).toFixed(2);
  document.getElementById("iPTotalAmount").value = ta;
}

function invoiceAddItem() {
  var table = document.getElementById("invoiceProductTable");
  var name = document.getElementById("iPName").value;
  var qty = document.getElementById("iPQuantity").value;
  var price = document.getElementById("iPPrice").value;
  var tax = document.getElementById("iPTax").value;
  var total = document.getElementById("iPTotalAmount").value;
  var final = document.getElementById("iFinalAmount").value;
  ...
  cell1.innerHTML = "<input name='rowInput["+count+"][pName]' class='form-control-plaintext' value='"+name+"'>";
  cell1.colSpan = 2;
  ...
  cell6.innerHTML = "<button type='button' class='btn btn-danger text-center' id='btn_add' onclick='invoiceDeleteItem(this.parentNode.parentNode,"+total+")'><i class='fa fa-ban'></i></button>";
  // var f = parseFloat(final);
  // var t = parseFloat(total);
  // console.log(tt);
  document.getElementById("iFinalAmount").value = ta;
}

function invoiceDeleteItem(delRow,total) {
  var final = document.getElementById("iFinalAmount").value;
  var f = parseFloat(final);
  var ta = f - total;
  ta = parseFloat(ta).toFixed(2);
  ...
  document.getElementById("invoiceProductTable").deleteRow(delRow.rowIndex);
  document.getElementById("iFinalAmount").value = ta;
}
